        ...
        <div class="login-container">
            ...
            <div class="form-container">
                ...
                <?php if(!empty($_GET["error"])){ ?>
                    <p style="border:2px solid #db6945; border-radius: 10px;padding:5px;"><b>Email ou mot de <br> passe incorrect !</b></p>
                <?php } ?>
                    <h1 class="opacity">LOGIN</h1>
                <form method="POST" action="../Connexion/traitementLogin.php">
                    <input type="email"  required="" name="email" placeholder="E-MAIL" />
                    <input type="password" name="password" placeholder="PASSWORD" required="" />
                    <button type="submit" class="opacity">CONNEXION</button>
                </form>
